...
public class ProductServiceImpl implements ProductService {
    ...
    @Override
    public Page<Product> gets(String name, String categoryId, Integer size, Double priceMin, Double priceMax, Pageable pageable) {
        return productRepository.findByNameContainsIgnoreCase(name, categoryId ,size, priceMin, priceMax, pageable);
    }
